-- Modified by softyay from `auto.lua` script by shadmansaleh
-- in their lualine neovim plugin
...
-- }
local colors = {
  normal  = utils.extract_highlight_colors('Identifier', 'fg'),
  command  = utils.extract_highlight_colors('Special', 'fg'),
  visual  = utils.extract_highlight_colors('Keyword', 'fg'),
  insert  = utils.extract_highlight_colors('String', 'fg'),
  replace  = utils.extract_highlight_colors('Number', 'fg'),
  screen_bg  = utils.extract_highlight_colors('Normal', 'bg'),
  normal_white_text  = utils.extract_highlight_colors('Normal', 'fg'),
  grey0  = utils.extract_highlight_colors('CursorLine', 'bg'),
  grey2  = utils.extract_highlight_colors('StatusLine', 'fg'),
  yellow  = utils.extract_highlight_colors('CursorLineNr', 'fg'),
  grey3  = utils.extract_highlight_colors('Comment', 'fg'),
}
...
M.colors = {
  normal = {
    a = { bg = colors.normal, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.normal },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.normal },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  insert = {
    a = { bg = colors.insert, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.insert },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.insert },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  replace = {
    a = { bg = colors.replace, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.replace },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.replace },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  visual = {
    a = { bg = colors.visual, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.visual },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.visual },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  command = {
    a = { bg = colors.command, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.command },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.command },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  terminal = {
    a = { bg = colors.normal_white_text, fg = colors.screen_bg },
    b = { bg = colors.grey2, fg = colors.normal_white_text },
    c = { bg = colors.grey0, fg = colors.grey3 },
    x = { bg = colors.grey0, fg = colors.grey3 },
    y = { bg = colors.grey2, fg = colors.normal_white_text },
    z = { bg = colors.grey3, fg = colors.screen_bg, gui = 'bold' },
  },
  inactive = {
    a = { bg = colors.grey2, fg = colors.screen_bg, gui = 'italic' },
    b = { bg = colors.grey0, fg = colors.grey2, gui = 'italic' },
    c = { bg = colors.screen_bg, fg = colors.grey2, gui = 'italic' },
    x = { bg = colors.screen_bg, fg = colors.grey2, gui = 'italic' },
    y = { bg = colors.grey0, fg = colors.grey2, gui = 'italic' },
    z = { bg = colors.grey2, fg = colors.screen_bg, gui = 'italic' },
  },
}
...
M.component_colors = {
  ...
  tabs = {
    active = { bg = colors.grey3, fg = colors.grey0 },
    inactive = { bg = colors.grey0, fg = colors.grey3 },
  },
}

-- Apply proper contrast so text is readable
for _, section in pairs(M.colors) do
